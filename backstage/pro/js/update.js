$(function () {
  ...
  $.ajax({
    type: 'get',
    url: url + 'getProjectByPid',
    data: 'username=' + username + '&pid=' + global.id,
    ...
    success: function (res) {
      console.log(res)
      $('#name').val(res.name)
      $('#address').val(res.adss)
      $('#remark').val(res.remark)
      $('#fireman').val(res.fName + ',' + res.fPhone)
      $('#fireman').attr('data-id',res.fireman)
      $('#personliable').val(res.zName + ',' + res.zPhone)
      $('#personliable').attr('data-id',res.personliable)
      
      createMap(res.longitude)
    }
  })

  function createMap(lnglat) {
    console.log(lnglat.split(','))
  ...
  $('#save-btn').click(function (e) {
    ...
    if (name == '') {
      ...
      $.ajax({
        type: 'get',
        url: url + '/editProject',
        data: 'name=' + name + '&username=' + username + '&adss=' + address + '&fireman=' + fireman + '&personliable=' + personliable + '&remark=' + remark +'&pid=' + global.id,
        error: function (error) {
          console.log(error)
        },
        success: function (result) {
